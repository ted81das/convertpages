<nav class="navbar navbar-expand topbar mb-4 static-top">
  ...
  <ul class="navbar-nav">
    <li class="nav-item dropdown no-arrow">
      <a class="nav-link dropdown-toggle" href="#" id="quickActionDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        <span class="mr-2 d-none d-lg-inline text-gray-600">
          @lang('Quick actions')
        </span>
        <i class="fas fa-plus fa-sm"></i>
      </a>
      <div class="dropdown-menu dropdown-menu-left shadow animated--grow-in" aria-labelledby="quickActionDropdown">
        {!! menuQuickActions() !!}
      </div>
    </li>
  </ul>
