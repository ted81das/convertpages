...
@section('title', __('Create Group catetory'))

@section('content')

<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">@lang('Create Group catetory')</h1>
</div>
<div class="row">
    <div class="col-md-3">                 
    ...
    <div class="col-md-9">
        ...
        <form role="form" method="post" action="{{ route('settings.groupcategories.store') }}" enctype="multipart/form-data">
            @csrf
            <div class="card">
                <div class="card-body">
                    <div class="row">
