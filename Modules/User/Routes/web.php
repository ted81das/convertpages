...
if (!config('app.DISABLE_REGISTER')) {
...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware('can:admin')->prefix('settings')->name('settings.')->group(function () {
        ...
        Route::get('impersonate/{id}', 'UserController@impersonate')->name('user.impersonate');
    });

    Route::get('leave-impersonate', 'UserController@impersonate')->name('user.impersonate.leave');
});