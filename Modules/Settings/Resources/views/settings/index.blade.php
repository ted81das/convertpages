                ...
                <div class="card-body">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6 text-center">
                            <img src="{{ Storage::url(config('app.logo_favicon'))}}" height="50" alt="">
                        </div>
                        ...
                        <div class="col-lg-6 text-center">
                            <img src="{{ Storage::url(config('app.logo_frontend')) }}" height="50" alt="">
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group">
                        ...
                        <div class="col-lg-6 text-center p-2" style="background-color: black">
                            <img src="{{ Storage::url(config('app.logo_light')) }}" height="50" alt="">
                        </div>
                    </div>
                    <hr>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="form-label">@lang('Disable register user')</label>
                                <label class="">
                                    <input type="checkbox" name="DISABLE_REGISTER" value="1" class="custom-switch-input" {{ config('app.DISABLE_REGISTER') ? 'checked' : '' }}>
                                    <span class="custom-switch-description">@lang('Disable register user')</span>
                                </label>
                            </div>
                        </div>
                    </div>
