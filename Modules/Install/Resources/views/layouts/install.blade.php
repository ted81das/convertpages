...
<head>
    ...
    <link rel="icon" href="{{ asset('storage/system/favicon.png') }}" type="image/png">
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('storage/system/favicon.png') }}" />
                ...
                <div class="container">
                        <div class="d-flex">
                                <span class="header-brand" href="#">
                                    <img src="{{ asset('storage/system/logo.svg') }}" class="header-brand-img" alt="">
                                </span>
                </div>
            </div>
